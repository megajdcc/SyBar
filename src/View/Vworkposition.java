...
public class Vworkposition extends javax.swing.JDialog {
    ...
    private void setListener(){
        ...
        catwork.addMouseListener(getController());
        getTextbusqueda().addKeyListener(getController());
    }
    ...
    public JTable getCatwork() {
        return catwork;
    }

    public void setCatwork(JTable catwork) {
        this.catwork = catwork;
    }
     ...
     * @param parent
     * @param modal */
    public Vworkposition(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        catwork = new javax.swing.JTable();
        ...
        header.setIcon(new javax.swing.ImageIcon(getClass().getResource("/View/img/Work_Position.jpg"))); // NOI18N
        ...
        catwork.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        catwork.setForeground(new java.awt.Color(0, 0, 0));
        catwork.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null},
                {null},
                {null},
        ...
        catwork.setToolTipText("Users");
        catwork.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        catwork.setFillsViewportHeight(true);
        catwork.setOpaque(false);
        catwork.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                catworkKeyReleased(evt);
            }
            public void keyTyped(java.awt.event.KeyEvent evt) {
                catworkKeyTyped(evt);
            }
        });
        jScrollPane1.setViewportView(catwork);
    ...
    private void TextbusquedaFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_TextbusquedaFocusGained
        String leyend = "Find the corresponding job position";
    ...
    private void catworkKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_catworkKeyReleased
        // TODO add your handling code here:
    }//GEN-LAST:event_catworkKeyReleased

    private void catworkKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_catworkKeyTyped
        // TODO add your handling code here:
    }//GEN-LAST:event_catworkKeyTyped

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JTextField Textbusqueda;
    private org.edisoncor.gui.panel.Panel cat;
    private javax.swing.JTable catwork;
